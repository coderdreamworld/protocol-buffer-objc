 ...
 **/
@interface PackMessRoot : GPBRootObject
@end

#pragma mark - helloworld

typedef GPB_ENUM(helloworld_FieldNumber) {
  helloworld_FieldNumber_Id_p = 1,
  helloworld_FieldNumber_Str = 2,
  helloworld_FieldNumber_Opt = 3,
};

@interface helloworld : GPBMessage
